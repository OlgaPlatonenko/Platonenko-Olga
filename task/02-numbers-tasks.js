...
function getAngleBetweenVectors(x1, y1, x2, y2) {
    ...
    let absVector1=Math.sqrt(x1**2+y1**2);
    let absVector2=Math.sqrt(x2**2+y2**2);
    let angel=Math.acos(scal/(absVector1*absVector2));
    return angel;
}
...
function getParallelipidedDiagonal(a,b,c) {
    var diagLengt=Math.sqrt(a**2+b**2+c**2);
    return diagLengt;
}
